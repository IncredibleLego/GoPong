...
func (n *NameInputScene) Draw(screen *ebiten.Image) {
	...
	menu.ScreenDraw(config.DefaultConfig.TextDimension, 100, 100, 255, 255, 255, 255, 1.5, screen, "Player "+strconv.Itoa(n.activePlayer+1)+", insert your name:")
	menu.ScreenDraw(config.DefaultConfig.TextDimension, 100, 150, 255, 255, 255, 255, 1.5, screen, n.playerNames[n.activePlayer])
	menu.ScreenDraw(config.DefaultConfig.TextDimension, 100, 200, 255, 255, 255, 255, 1.2, screen, "Press Enter to confirm")
